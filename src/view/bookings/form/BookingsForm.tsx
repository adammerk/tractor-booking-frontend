...
import MachinesAutocompleteFormItem from 'src/view/machines/autocomplete/MachinesAutocompleteFormItem';
...
const schema = yup.object().shape({
  ...
  bookingStart: yupFormSchemas.datetime(
    i18n('entities.bookings.fields.bookingStart'),
    {
      "required": true
    },
  ),
  bookingEnd: yupFormSchemas.datetime(
  ...
  returned: yupFormSchemas.boolean(
...
function BookingsForm(props) {
  const [initialValues] = useState(() => {
    ...
    return {
      ...
      bookingStart: record.bookingStart ? moment(record.bookingStart) : null,
      bookingEnd: record.bookingEnd ? moment(record.bookingEnd) : null,
          ...
          <Grid spacing={2} container>
            ...
            <Grid item lg={7} md={8} sm={12} xs={12}>
              <FilesFormItem
                ...
                required={false}
                storage={Storage.values.bookingsAttachments}
                max={3}
                formats={["txt","pdf"]}
              />
            </Grid>
