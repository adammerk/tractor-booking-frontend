...
import MobilePhoneStatusListItem from 'src/view/mobilePhoneStatus/list/MobilePhoneStatusListItem';
import PreferedBookingChannelListItem from 'src/view/preferedBookingChannel/list/PreferedBookingChannelListItem';
          ...
          <TableHead>
            <TableRow>
              ...
              <TableCellCustom
                ...
                name={'addressLine1'}
                label={i18n(
                  'entities.customer.fields.addressLine1',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'addressLine2'}
                label={i18n(
                  'entities.customer.fields.addressLine2',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                name={'geoLocation'}
                label={i18n(
                  'entities.customer.fields.geoLocation',
                )}
              />
              <TableCellCustom
                onSort={doChangeSort}
                ...
                label={i18n(
                  'entities.customer.fields.mobilePhoneNumber',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.customer.fields.mobilePhoneStatus',
                )}
              />
              <TableCellCustom
                label={i18n(
                  'entities.customer.fields.preferedBookingChannel',
                )}
              />              
          ...
          <TableBody>
            ...
            {!loading &&
              rows.map((row) => (
                ...
                <TableCell>
                  <MobilePhoneStatusListItem value={row.mobilePhoneStatus} />
                </TableCell>
                <TableCell>
                  <PreferedBookingChannelListItem value={row.preferedBookingChannel} />
                </TableCell>                  
                  <TableCell>
                    <Box
                      display="flex"
