  ...
  entities: {
    customer: {
        ...
        fields: {
          ...
          'mobilePhoneStatus': 'MobilePhoneStatus',
          'preferedBookingChannel': 'PreferedBookingChannel',
          createdAt: 'Criado em',
    ...
    machines: {
        ...
        label: 'Machines',
        menu: 'Machines',
        exporterFileName: 'Machines_exportados',
        list: {
          menu: 'Machines',
          title: 'Machines',
        },
        create: {
          success: 'Machines salvo com sucesso',
        },
        update: {
          success: 'Machines salvo com sucesso',
        },
        destroy: {
          success: 'Machines deletado com sucesso',
        },
        destroyAll: {
          success: 'Machines(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Machines',
        },
        fields: {
          id: 'Id',
        ...
        view: {
          title: 'Visualizar Machines',
        },
        importer: {
          title: 'Importar Machines',
          fileName: 'machines_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    bookings: {
        ...
        label: 'Bookings',
        menu: 'Bookings',
        exporterFileName: 'Bookings_exportados',
        list: {
          menu: 'Bookings',
          title: 'Bookings',
        },
        create: {
          success: 'Bookings salvo com sucesso',
        },
        update: {
          success: 'Bookings salvo com sucesso',
        },
        destroy: {
          success: 'Bookings deletado com sucesso',
        },
        destroyAll: {
          success: 'Bookings(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Bookings',
        },
        fields: {
          id: 'Id',
          'customer': 'Customer',
          'products': 'Products',
          'employee': 'Employee',
          'bookingStartRange': 'Booking Start',
          'bookingStart': 'Booking Start',
          'bookingEndRange': 'BookingEnd',
        ...
        view: {
          title: 'Visualizar Bookings',
        },
        importer: {
          title: 'Importar Bookings',
          fileName: 'bookings_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    machineTypes: {
        ...
        label: 'Machine Types',
        menu: 'Machine Types',
        exporterFileName: 'Machine Types_exportados',
        list: {
          menu: 'Machine Types',
          title: 'Machine Types',
        },
        create: {
          success: 'Machine Types salvo com sucesso',
        },
        update: {
          success: 'Machine Types salvo com sucesso',
        },
        destroy: {
          success: 'Machine Types deletado com sucesso',
        },
        destroyAll: {
          success: 'Machine Types(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Machine Types',
        },
        fields: {
          id: 'Id',
        ...
        new: {
          title: 'Novo Machine Types',
        },
        view: {
          title: 'Visualizar Machine Types',
        },
        importer: {
          title: 'Importar Machine Types',
          fileName: 'machineTypes_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    locations: {
        ...
        label: 'Locations',
        menu: 'Locations',
        exporterFileName: 'Locations_exportados',
        list: {
          menu: 'Locations',
          title: 'Locations',
        },
        create: {
          success: 'Locations salvo com sucesso',
        },
        update: {
          success: 'Locations salvo com sucesso',
        },
        destroy: {
          success: 'Locations deletado com sucesso',
        },
        destroyAll: {
          success: 'Locations(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar Locations',
        },
        fields: {
          id: 'Id',
        ...
        new: {
          title: 'Novo Locations',
        },
        view: {
          title: 'Visualizar Locations',
        },
        importer: {
          title: 'Importar Locations',
          fileName: 'locations_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    mobilePhoneStatus: {
        ...
        label: 'MobilePhoneStatuses',
        menu: 'MobilePhoneStatuses',
        exporterFileName: 'MobilePhoneStatus_exportados',
        list: {
          menu: 'MobilePhoneStatuses',
          title: 'MobilePhoneStatuses',
        },
        create: {
          success: 'MobilePhoneStatus salvo com sucesso',
        },
        update: {
          success: 'MobilePhoneStatus salvo com sucesso',
        },
        destroy: {
          success: 'MobilePhoneStatus deletado com sucesso',
        },
        destroyAll: {
          success: 'MobilePhoneStatus(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar MobilePhoneStatus',
        },
        fields: {
          id: 'Id',
          'mobilePhoneStatus': 'MobilePhoneStatus',
        ...
        new: {
          title: 'Novo MobilePhoneStatus',
        },
        view: {
          title: 'Visualizar MobilePhoneStatus',
        },
        importer: {
          title: 'Importar MobilePhoneStatuses',
          fileName: 'mobilePhoneStatus_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
    ...
    preferedBookingChannel: {
        ...
        label: 'PreferedBookingChannels',
        menu: 'PreferedBookingChannels',
        exporterFileName: 'PreferedBookingChannel_exportados',
        list: {
          menu: 'PreferedBookingChannels',
          title: 'PreferedBookingChannels',
        },
        create: {
          success: 'PreferedBookingChannel salvo com sucesso',
        },
        update: {
          success: 'PreferedBookingChannel salvo com sucesso',
        },
        destroy: {
          success: 'PreferedBookingChannel deletado com sucesso',
        },
        destroyAll: {
          success: 'PreferedBookingChannel(s) deletado com sucesso',
        },
        edit: {
          title: 'Editar PreferedBookingChannel',
        },
        fields: {
          id: 'Id',
          'preferedBookingChannel': 'PreferedBookingChannel',
        ...
        new: {
          title: 'Novo PreferedBookingChannel',
        },
        view: {
          title: 'Visualizar PreferedBookingChannel',
        },
        importer: {
          title: 'Importar PreferedBookingChannels',
          fileName: 'preferedBookingChannel_template_importacao',
          hint:
            'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
        },
      },
