const es = {
  ...
  entities: {
    ...
    machines: {
        ...
        label: 'Machines',
        menu: 'Machines',
        exporterFileName: 'exportacion_machines',
        list: {
          menu: 'Machines',
          title: 'Machines',
        },
        create: {
          success: 'Machines guardado con éxito',
        },
        update: {
          success: 'Machines guardado con éxito',
        },
        destroy: {
          success: 'Machines eliminado con éxito',
        },
        destroyAll: {
          success: 'Machines(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'machines_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    bookings: {
        ...
        label: 'Bookings',
        menu: 'Bookings',
        exporterFileName: 'exportacion_bookings',
        list: {
          menu: 'Bookings',
          title: 'Bookings',
        },
        create: {
          success: 'Bookings guardado con éxito',
        },
        update: {
          success: 'Bookings guardado con éxito',
        },
        destroy: {
          success: 'Bookings eliminado con éxito',
        },
        destroyAll: {
          success: 'Bookings(s) eliminado con éxito',
        },
        edit: {
        ...
        importer: {
          ...
          fileName: 'bookings_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    machineTypes: {
        ...
        label: 'Machine Types',
        menu: 'Machine Types',
        exporterFileName: 'exportacion_machineTypes',
        list: {
          menu: 'Machine Types',
          title: 'Machine Types',
        },
        create: {
          success: 'Machine Types guardado con éxito',
        },
        update: {
          success: 'Machine Types guardado con éxito',
        },
        destroy: {
          success: 'Machine Types eliminado con éxito',
        },
        destroyAll: {
          success: 'Machine Types(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo Machine Types',
        },
        view: {
          title: 'Ver Machine Types',
        },
        importer: {
          title: 'Importar Machine Types',
          fileName: 'machineTypes_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    locations: {
        ...
        label: 'Locations',
        menu: 'Locations',
        exporterFileName: 'exportacion_locations',
        list: {
          menu: 'Locations',
          title: 'Locations',
        },
        create: {
          success: 'Locations guardado con éxito',
        },
        update: {
          success: 'Locations guardado con éxito',
        },
        destroy: {
          success: 'Locations eliminado con éxito',
        },
        destroyAll: {
          success: 'Locations(s) eliminado con éxito',
        },
        edit: {
    ...
    mobilePhoneStatus: {
        ...
        exporterFileName: 'exportacion_mobilePhoneStatus',
        list: {
          menu: 'MobilePhoneStatuses',
          title: 'MobilePhoneStatuses',
        },
        create: {
          success: 'MobilePhoneStatus guardado con éxito',
        },
        update: {
          success: 'MobilePhoneStatus guardado con éxito',
        },
        destroy: {
          success: 'MobilePhoneStatus eliminado con éxito',
        },
        destroyAll: {
          success: 'MobilePhoneStatus(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo MobilePhoneStatus',
        },
        view: {
          title: 'Ver MobilePhoneStatus',
        },
        importer: {
          title: 'Importar MobilePhoneStatuses',
          fileName: 'mobilePhoneStatus_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
    ...
    preferedBookingChannel: {
        ...
        exporterFileName: 'exportacion_preferedBookingChannel',
        list: {
          menu: 'PreferedBookingChannels',
          title: 'PreferedBookingChannels',
        },
        create: {
          success: 'PreferedBookingChannel guardado con éxito',
        },
        update: {
          success: 'PreferedBookingChannel guardado con éxito',
        },
        destroy: {
          success: 'PreferedBookingChannel eliminado con éxito',
        },
        destroyAll: {
          success: 'PreferedBookingChannel(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo PreferedBookingChannel',
        },
        view: {
          title: 'Ver PreferedBookingChannel',
        },
        importer: {
          title: 'Importar PreferedBookingChannels',
          fileName: 'preferedBookingChannel_import_template',
          hint:
            'Las columnas Archivos/Imágenes deben ser las URL de los archivos separados por espacio.',
        },
      },
